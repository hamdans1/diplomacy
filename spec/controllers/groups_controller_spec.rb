...
RSpec.describe GroupsController, type: :controller do
  ...
  context "member user" do
    before do
      user = User.create!(name: "DiploUser", email: "user@diplo.com", password: "helloworld", role: :member)
      create_session(user)
    end
    ...
    describe "GET index" do
      ...
      it "assigns Group.all to group" do
        get :index
        expect(assigns(:groups)).to eq([my_group])
      end
  ...
  context "admin user" do
    before do
      user = User.create!(name: "DiploUser", email: "user@diplo.com", password: "helloworld", role: :admin)
      create_session(user)
    end
